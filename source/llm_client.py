"""
LLM client for content-analyser.
...
class LLMConfig:
    ...
    def from_env(cls) -> "LLMConfig":
        ...
        Uses:
            VLLM_BASE_URL: LLM endpoint (required for this service)
        ...
        Raises:
            ValueError: If VLLM_BASE_URL is not set.
        """
...
class LLMClient:
    ...
    Usage::
        ...
        answer = client.ask("Some document text", "Analyse for topics.")
    """
